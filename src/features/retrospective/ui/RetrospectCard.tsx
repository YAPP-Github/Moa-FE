...
export function RetrospectCard({ retrospect }: RetrospectCardProps) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4 hover:border-primary-300 transition-colors cursor-pointer">
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <h3 className="text-body-1 font-medium text-gray-900 truncate">
        ...
        <span className="ml-2 shrink-0 rounded-full bg-gray-100 px-2 py-0.5 text-caption text-gray-600">
          {methodLabel}
        </span>
      </div>
    </div>
